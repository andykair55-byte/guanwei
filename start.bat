...
start "JW-Backend" cmd /k "cd /d D:\code\code\program\4-¹ÛÎ¢\backend && uvicorn main:app --reload --host 0.0.0.0 --port 8000"

timeout /t 2 /nobreak >nul

echo [2/2] Starting Frontend (Vite :5173)...
start "JW-Frontend" cmd /k "cd /d D:\code\code\program\4-¹ÛÎ¢ && npm run dev"
